...
WebUI.navigateToUrl('nutriclub.eydendigital.co.id/account/register')
...
WebUI.setEncryptedText(findTestObject('Register - Nutriclub/input_Konfirmasi Password_ConfirmPassword'), 'iFGeFYmXIrUhQZHvW7P22w==')
